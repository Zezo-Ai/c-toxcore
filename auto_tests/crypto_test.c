...
static void test_noiseik(void)
{
    ...
    noise_handshake_init(noise_handshake_initiator, init_static_pub, init_remote_static, true, prologue, sizeof(prologue));
    ...
    noise_encrypt_and_hash(ciphertext1, init_static_pub, CRYPTO_PUBLIC_KEY_SIZE, noise_handshake_temp_key,
    ...
    noise_mix_key(noise_handshake_initiator->chaining_key, noise_handshake_temp_key,
                  init_static, noise_handshake_initiator->remote_static);
    ...
    noise_handshake_init(noise_handshake_responder, resp_static_pub, nullptr, false, prologue, sizeof(prologue));
    ...
    noise_mix_key(noise_handshake_responder->chaining_key, noise_handshake_temp_key_resp,
                  resp_static, noise_handshake_responder->remote_ephemeral);
    ...
    /* ss */
    noise_mix_key(noise_handshake_responder->chaining_key, noise_handshake_temp_key_resp, resp_static,
    ...
    /* se */
    noise_mix_key(noise_handshake_initiator->chaining_key, noise_handshake_temp_key_init, init_static,
                  noise_handshake_initiator->remote_ephemeral);
